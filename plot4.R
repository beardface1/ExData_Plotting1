...
par(mfrow = c(2, 2))
with(airquality, {
        plot(dfg$datetime, dfg$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
        plot(dfg$datetime, dfg$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
        ...
        plot(dfg$datetime, dfg$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
})
